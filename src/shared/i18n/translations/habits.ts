...
export const habitsTranslations = {
  en: {
    ...
    'habits.weeklyScore': 'Weekly score',
    'habits.currentStreak': 'Current streak',
    'habits.totalLogs': 'Total logs',
    'habits.completionRate': 'Completion',
  ...
  es: {
    ...
    'habits.weeklyScore': 'Puntaje semanal',
    'habits.currentStreak': 'Racha actual',
    'habits.totalLogs': 'Registros totales',
    'habits.completionRate': 'Cumplimiento',
