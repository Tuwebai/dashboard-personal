...
export const authTranslations = {
  en: {
    ...
    'auth.linkAccount': 'Protect guest data with email',
    'auth.linkAccountHint': 'To keep your current data, create your account from guest mode.',
  ...
  es: {
    ...
    'auth.linkAccount': 'Proteger datos invitados con correo',
    'auth.linkAccountHint': 'Para conservar tus datos actuales, creá tu cuenta desde el modo invitado.',
